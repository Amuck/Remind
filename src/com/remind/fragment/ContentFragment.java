...
public class ContentFragment extends Fragment {
    ...
    private void setViewUp(View view) {
        ...
        remindTypeSpinner = (CustomSinnper) view.findViewById(R.id.title_spinner);
        setupSpinner();
    ...
    private void setupSpinner() {
        ...
        remindTypeAdapter = new ArrayAdapter<String>(getActivity(), R.layout.simple_spinner_item, mItems);
        // 绑定 Adapter到控件
    ...
    class AppAdapter extends BaseAdapter {
        ...
        public View getView(int position, View convertView, ViewGroup parent) {
            if (convertView == null) {
                convertView = View.inflate(mContext.getApplicationContext(), R.layout.item_list_app, null);
         ...
         * @return
         */
        private void getBtnStatus(RemindEntity item, Button stateBtn, Button refuseBtn) {
            String status = "接受";
    ...
    public void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        case ADD_REMIND:
            ...
            remindTypeSpinner.setAdapter(remindTypeAdapter, RemindEntity.LAUNCH);
            break;
        case CHAT:
            // 刷新最后的聊天内容和时间，发送状态
