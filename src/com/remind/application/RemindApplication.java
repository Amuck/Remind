...
public class RemindApplication extends Application {
    ...
    public final static int GET_WEATHER_UI = 1000004;// 刷新UI
        ...
        public void handleMessage(Message msg) {
            ...
            case GET_WEATHER_UI:
                if (mLocationResult != null) {
                    mLocationResult.setText(msg.getData().getString("location"));
                }
                break;
            }
        }
    ...
    public void showLoc(String str) {
        try {
            ...
            msg.what = GET_WEATHER_OK;
            Bundle data = new Bundle();
            data.putString("location", str);
            msg.setData(data);
    ...
    public void getCityCode() {
        new Thread(new Runnable() {
            ...
            public void run() {
                Looper.prepare();
                String url = "http://apistore.baidu.com/microservice/cityinfo?cityname=" + getCityForWeather();
                WeatherGetRequest getRequest = new WeatherGetRequest(url, new Listener<String>() {
    ...
    public void getWeatherByCode() {
        new Thread(new Runnable() {
            ...
            public void run() {
                ...
                String url = "http://wthrcdn.etouch.cn/weather_mini?citykey=" + code;
                WeatherGetRequest getRequest = new WeatherGetRequest(url, new Listener<String>() {
                    ...
                    public void onResponse(String response) {
                        ...
                        if (null != response && !"".equals(response)) {
                            try {
                                ...
                                String list = cotent.getString("forecast");
                                JSONArray datas = new JSONArray(list);
                                JSONObject today = datas.getJSONObject(0);
                                String weather = today.getString("type");
                                showWeather(weather);
                                showTemp(temp);
                                // code = cotent.getString("cityCode");
    ...
    public void getWeatherImg(String weather) {
        ...
        } else if (weather.equals("阴") || weather.equals("Overcast")) {
            mWeatherIconFlg = WEATHER_YIN;
        } else if (weather.equals("冻雨")) {
            mWeatherIconFlg = WEATHER_DONGYU;
        } else if (weather.equals("雪") || weather.equals("小雪") || weather.equals("Light snow") || weather.equals("Snow")) {
        ...
        } else if (weather.equals("雨夹雪") || weather.equals("Sleet")) {
            mWeatherIconFlg = WEATHER_YUJIAXUE;
        } else if (weather.equals("阵雪")) {
            mWeatherIconFlg = WEATHER_ZHENXUE;
        } else if (weather.equals("雷阵雨") || weather.equals("Thunderstorm")) {
        ...
        } else if (weather.equals("大雨") || weather.equals("中到大雨") || weather.equals("中雨转大雨") || weather.equals("Pour")) {
        ...
        } else if (weather.contains("雹") || weather.equals("冰雹") || weather.equals("雨加冰雹") || weather.equals("雷阵雨伴有冰雹")) {
