...
//        Log.d(TAG, sql);
    ...
    public Cursor queryRemind(RemindEntity entity) {
        Cursor mCursor = null;
        StringBuffer sb = new StringBuffer();
        sb.append("select * from " + RemindMsg.TABLENAME + " where " );
        sb.append( RemindMsg.OWNER_NUM + " = '" + AppConstant.USER_NUM + "' ");
    ...
    public Cursor queryRemind() {
        SQLiteDatabase db = mDBHelper.getWritableDatabase();
        String sql = "select * from " + RemindMsg.TABLENAME + " where " + RemindMsg.IS_DELETE + " = 0 " + " and "
                + RemindMsg.OWNER_NUM + " = '" + AppConstant.USER_NUM + "' " + " order by " + RemindMsg.REMIND_TIME_MILI;
        Cursor mCursor = null;
        mCursor = db.rawQuery(sql, null);
        return mCursor;
    }
    ...
    @Override
    public Cursor getDeletedRemind() {
        SQLiteDatabase db = mDBHelper.getWritableDatabase();
        StringBuffer sb = new StringBuffer();
        sb.append(" select * from  ");
        sb.append(RemindMsg.TABLENAME);
...
//        Log.d(TAG, sql);
    ...
    public Cursor queryRemindByNoticeId(String noticeId) {
        SQLiteDatabase db = mDBHelper.getWritableDatabase();
        String sql = "select * from " + RemindMsg.TABLENAME + " where " + RemindMsg.IS_DELETE + " = 0 and "
                + RemindMsg.NOTICE_ID + " = '" + noticeId + "'" + " and " + RemindMsg.OWNER_NUM + " = '"
