...
/**
 * 提醒，需要根据提醒重复模式（REPEAT_TYPE）来计算下一次提醒时间（REMIND_TIME，
 * REMIND_TIME_MILI），每次提醒增加提醒次数REMIND_COUNT；
 * 
 * 
 * @author ChenLong
 * 
...
public class RemindMsg {
    ...
    /**
     * 提醒方式, 音频：0, 视频:1, 图像:2, 默认为音频
     */
    public static final String REMIND_METHOD = "remindMethod";
    /**
     * 提醒的状态, 已接受：0, 新提醒：1, 已拒绝：2, 我发起的：3, 默认为新提醒
     */
    public static final String REMIND_STATE = "remindState";

    /**
     * 我发起的提醒的状态， 等待对方接受：4, 对方已拒绝：5, 对方已接受：6, 默认为等待对方接受
     */
