...
public class SwipeMenuLayout extends FrameLayout {
    ...
    private void swipe(int dis) {
        ...
        mMenuView.layout(mContentView.getWidth() - dis, mMenuView.getTop(), mContentView.getWidth() + mMenuView.getWidth()
    ...
    protected void onLayout(boolean changed, int l, int t, int r, int b) {
        ...
        mMenuView.layout(getMeasuredWidth(), 0, getMeasuredWidth() + mMenuView.getMeasuredWidth(), getMeasuredHeight());
