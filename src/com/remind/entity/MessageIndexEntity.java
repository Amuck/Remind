...
public class MessageIndexEntity implements Serializable {
     ...
     *            登陆用户
     */
    public MessageIndexEntity(String id, String num, String message, String time, String name, String imgPath,
            int unReadCount, String isDelete, String sendState, String loginUser) {
        super();
        this.id = id;
        this.num = num;
