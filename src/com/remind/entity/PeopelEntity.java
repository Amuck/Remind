...
public class PeopelEntity implements Serializable {
    ...
    /**
     * 好友状态，{@link #VALIDATE}：等待对方验证 {@link #ACCEPT}：等待用户接受 {@link #FRIEND}
     * ：已添加的好友
     */
    private int status;
     ...
     *            登陆用户
     */
    public PeopelEntity(String name, String nickName, String num, String addTime, String updateTime, String imgPath,
