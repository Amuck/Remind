...
/**
 * An example animation handler Animates translation, rotation, scale and alpha
 * at the same time using Property Animation APIs.
 */
public class DefaultAnimationHandler extends MenuAnimationHandler {
    ...
    public void animateMenuOpening(Point center) {
        ...
        for (int i = 0; i < menu.getSubActionItems().size(); i++) {
            ...
            PropertyValuesHolder pvhX = PropertyValuesHolder.ofFloat(View.TRANSLATION_X, menu.getSubActionItems().get(i).x
                    - center.x + menu.getSubActionItems().get(i).width / 2);
            PropertyValuesHolder pvhY = PropertyValuesHolder.ofFloat(View.TRANSLATION_Y, menu.getSubActionItems().get(i).y
                    - center.y + menu.getSubActionItems().get(i).height / 2);
            ...
            // Put a slight lag between each of the menu items to make it
            // asymmetric
