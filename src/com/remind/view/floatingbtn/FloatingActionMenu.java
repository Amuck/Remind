...
import com.remind.view.floatingbtn.animation.DefaultAnimationHandler;
import com.remind.view.floatingbtn.animation.MenuAnimationHandler;
    ...
    public void open(boolean animated) {
        ...
        if (animated && animationHandler != null) {
            ...
            for (int i = 0; i < subActionItems.size(); i++) {
                ...
                if (systemOverlay) {
                    params.setMargins(center.x - overlayParams.x - subActionItems.get(i).width / 2, center.y
                            - overlayParams.y - subActionItems.get(i).height / 2, 0, 0);
                } else {
                    params.setMargins(center.x - subActionItems.get(i).width / 2, center.y - subActionItems.get(i).height
                            / 2, 0, 0);
                }
            ...
            for (int i = 0; i < subActionItems.size(); i++) {
                ...
                final FrameLayout.LayoutParams params = new FrameLayout.LayoutParams(subActionItems.get(i).width,
                        subActionItems.get(i).height, Gravity.TOP | Gravity.LEFT);
                if (systemOverlay) {
                    params.setMargins(subActionItems.get(i).x - overlayParams.x, subActionItems.get(i).y - overlayParams.y,
                            0, 0);
