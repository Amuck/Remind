...
public class HighlightView {
     ...
     */
    private void init() {
        mResizeDrawableDiagonal = AppUtil.bitmapToDrawable(AppUtil.getBitmapFormSrc("image/crop_big.png"));
        mResizeDrawableDiagonal2 = AppUtil.bitmapToDrawable(AppUtil.getBitmapFormSrc("image/crop_small.png"));
    }
