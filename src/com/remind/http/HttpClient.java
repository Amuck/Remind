...
public class HttpClient {
    ...
    /**
     * @author ChenLong curl -XPOST http://127.0.0.1:8008/notice/status -d
     *         "{\"user_id\":\"bfa3e1dd3865915333079226c19120097c437ee5\",
     *         \"notice_id\":\"a02cc9804c2e8b52657db406c624c8c00f4ba8e7\",
     *         \”status
     *         \":1,\"owner_id\":\"81a95d871f661e13bc64fe5868592b2292dd1fc2\"}"
     *         -v
     */
     ...
     * @return
     */
    public static String getCreateNofiJsonForPost(String user_id, String owner_id, String title, String isPrev, String time,
            String type, String userNum, String userNick, String noticeContent, String addTime, int remindState,
            int remindMethod, String audioPath, String imagePath, String videoPath) {
        Gson gson = new Gson();
        String result = "";
