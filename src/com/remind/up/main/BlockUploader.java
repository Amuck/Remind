...
import com.remind.up.commom.Params;
import com.remind.up.exception.UpYunException;
import com.remind.up.http.HttpManager;
import com.remind.up.http.PostData;
import com.remind.up.http.ResponseJson;
...
public class BlockUploader implements Runnable {
    ...
    public BlockUploader(HttpManager httpManager, String host, String bucket, File localFile, int blockSize,
            long expiration, String policy, String signature, ProgressListener progressListener,
                ...
                public void result(boolean isSuccess, String response, String error) {
                    if (!isSuccess) {
                        ...
                        try {
                            ...
                            String exceptionJson = ResponseJson.exceptionJsonFormat(Params.INIT_REQUEST_ERROR,
                                    err.getMessage());
