...
public class ChatAdapter extends BaseAdapter {
        ...
        public void handleMessage(android.os.Message msg) {
            ...
            case REFRESH_UI:
                ...
                if (null == s || !s.contains("|")) {
                    Toast.makeText(context, "网络连接失败，请确认后重试.", Toast.LENGTH_SHORT).show();
                }
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            ...
            if (MessageEntity.TYPE_RECIEVE.equals(chatMessage.getIsComing())) {
                ...
                // viewHolder.chatPanel = (LinearLayout)
                // convertView.findViewById(R.id.from_chat_panel);
                viewHolder.chatRemindPanel = (LinearLayout) convertView.findViewById(R.id.chat_from_remind);
                viewHolder.time = (TextView) convertView.findViewById(R.id.chat_from_createDate);
                viewHolder.title = (TextView) convertView.findViewById(R.id.chat_from_title);
                viewHolder.remindState = (TextView) convertView.findViewById(R.id.chat_from_remind_state);
                viewHolder.date = (TextView) convertView.findViewById(R.id.chat_from_remind_time);
                viewHolder.content = (TextView) convertView.findViewById(R.id.chat_from_content);
                viewHolder.state = (TextView) convertView.findViewById(R.id.send_state);
                // viewHolder.contentImg = (ImageView) convertView.
                // findViewById(R.id.chat_from_img);
                viewHolder.personImg = (RoleDetailImageView) convertView.findViewById(R.id.chat_from_icon);
                viewHolder.ok = (TextView) convertView.findViewById(R.id.from_button_ok);
                viewHolder.cancel = (TextView) convertView.findViewById(R.id.from_button_cancel);
                convertView.setTag(viewHolder);
            } else {
                convertView = mInflater.inflate(R.layout.main_chat_send_msg, null);
                // viewHolder.chatPanel = (LinearLayout)
                // convertView.findViewById(R.id.send_chat_panel);
                viewHolder.chatRemindPanel = (LinearLayout) convertView.findViewById(R.id.chat_send_remind);
                viewHolder.time = (TextView) convertView.findViewById(R.id.chat_send_createDate);
                viewHolder.title = (TextView) convertView.findViewById(R.id.chat_send_title);
                viewHolder.remindState = (TextView) convertView.findViewById(R.id.chat_send_remind_state);
                viewHolder.date = (TextView) convertView.findViewById(R.id.chat_send_remind_time);
                viewHolder.content = (TextView) convertView.findViewById(R.id.chat_send_content);
                viewHolder.state = (TextView) convertView.findViewById(R.id.send_state);
                // viewHolder.contentImg = (ImageView) convertView.
                // findViewById(R.id.chat_send_img);
                viewHolder.personImg = (RoleDetailImageView) convertView.findViewById(R.id.chat_send_icon);
                viewHolder.ok = (TextView) convertView.findViewById(R.id.send_button_ok);
                viewHolder.cancel = (TextView) convertView.findViewById(R.id.send_button_cancel);
                convertView.setTag(viewHolder);
            }
    ...
    private void changeMsgType(String type, final ViewHolder viewHolder, MessageEntity chatMessage) {
        ...
        if (MessageEntity.TYPE_TEXT.equals(type)) {
            ...
            default:
                if (remindState / 10 == 0) {
                    // 闹钟失效, 更新提醒状态
                    remindDao.logicDeleteById(entity.getId());
                }
    ...
    private void agreeNotice(final RemindEntity entity, final int state) {
        final String params = HttpClient.getJsonForPost(HttpClient.agreeNotice(entity.getNoticeId(), state, "",
                entity.getOwnerId()));
